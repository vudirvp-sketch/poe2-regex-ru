...
Генератор поисковых regex-строк для **Path of Exile 2** (русский клиент).

Выбираете моды → получаете оптимизированную строку для вставки в поисковое окно игры. Работает с лимитом 250 символов, автоматически сокращает regex через дедупликацию, группировку и ёфикацию.
