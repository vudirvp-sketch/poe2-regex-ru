...
| Тестирование | Vitest 4 (1992 теста), проверено в реальной игре (`docs/IN_GAME_TESTS.md`) |
...
# Тесты
pnpm test              # 1992/1992 должно пройти
...
| Файл | Назначение |
|------|-----------|
| [`AGENT_NAVIGATION.md`](./AGENT_NAVIGATION.md) | **Entry document для AI-агентов** — где что лежит, path aliases, dependency rules, 39 pitfall-паттернов |
