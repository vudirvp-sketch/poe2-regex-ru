...
| Тестирование | Vitest 4 (2165 тестов), проверено в реальной игре (`docs/IN_GAME_TESTS.md`) |
...
# Тесты
pnpm test              # 2165/2165 должно пройти
...
| Файл | Назначение |
|------|-----------|
| [`AGENT_NAVIGATION.md`](./AGENT_NAVIGATION.md) | **Entry document для AI-агентов** — где что лежит, path aliases, dependency rules, 49 pitfall-паттернов |
| [`STATUS.md`](./STATUS.md) | Текущий статус итерации (iter 139), Known Issues, подтверждённые ограничения PoE2 |
