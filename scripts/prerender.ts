...
const routes: RouteMeta[] = [
  {
    path: '/',
    title: 'PoE2 Regex — Регексы и фильтрация предметов для Path of Exile 2 (русский клиент)',
    description: 'Генератор регексов и поисковых строк для фильтрации предметов Path of Exile 2 на русском языке. Путевые камни, башни предтеч, реликвии, самоцветы, пояса, кольца, амулеты, торговец. Regex, регулярные выражения, фильтр лута PoE2.',
    noscriptIntro: 'Генератор регексов для фильтрации предметов Path of Exile 2 на русском языке. Создавайте поисковые строки для путевых камней, реликвий, самоцветов, колец, амулетов и других категорий.',
  },
  {
    path: '/waystone',
  ...
  {
    path: '/tablet',
    title: 'Башни предтеч PoE2 — Генератор регексов | PoE2 Regex',
    description: 'Генератор поисковых строк для башен предтеч Path of Exile 2 на русском языке. Ритуал, бездна, делириум, ваал, экспедиция — фильтрация аффиксов плиток.',
    noscriptIntro: 'Фильтрация башен предтеч Path of Exile 2. Ритуал, бездна, делириум, ваал, экспедиция — выберите нужные свойства и скопируйте поисковую строку.',
  },
  {
    path: '/relic',
