...
export function range(min?: number, max?: number, suffix?: string, prefix?: string, exact?: boolean, anchorStart?: boolean, anchorEnd?: string): ASTNode {
  return { type: 'RANGE', min, max, suffix, prefix, exact, anchorStart, anchorEnd };
}
