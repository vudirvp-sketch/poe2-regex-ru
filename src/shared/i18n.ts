...
const translations: Record<Locale, Record<string, string>> = {
  ru: {
    ...
    'home.title': 'Поисковые строки PoE2 — русский клиент',
    'home.subtitle': 'Регулярные выражения для фильтрации лута в русском клиенте',
    'home.description_full': 'Генератор поисковых строк для фильтра предметов Path of Exile 2. Выбираете аффиксы — получаете готовую regex-строку для вставки в игру. Автообновление с poe2db.tw, оптимизация под лимит 250 символов, сохранение фильтров в профилях и обмен ссылками.',
