...
const translations: Record<Locale, Record<string, string>> = {
  ru: {
    ...
    'regex.budget_warning': 'Осталось {chars} символов из 250 при {mods} модах. Добавление новых модов может привести к переполнению!',
    ...
    'chip.exclude_tooltip': 'Исключить этот мод (не хочу)',
    'chip.unexclude_tooltip': 'Убрать из исключения',
    'chip.exclude_aria': 'Исключить мод',
    'chip.unexclude_aria': 'Убрать мод из исключения',
