...
const translations: Record<Locale, Record<string, string>> = {
  ru: {
    ...
    'regex.copy_shortcut': 'Копировать (Ctrl+Shift+C)',
    ...
    'range.min_aria_dual': 'Минимальное значение первого числа',
    'range.max_aria_dual': 'Максимальное значение первого числа',
