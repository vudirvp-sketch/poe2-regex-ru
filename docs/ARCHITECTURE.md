...
> **Version:** 57.0 | **Date:** 2026-06-16 | **Language:** RU-first
...
**Path D — same-family OR strategy (iter 38):**
...
This is the WORKING replacement for the broken opt-table pattern `"prefix (A|B|C)"` (Tests 16-17). Verified in-game for 2 alternatives (D7-3); 3+ alternatives pending verification.
...
### Principle 8: SAME-FAMILY OR — Path D (iter 38, verified)
...
**Status:**
- ✅ 2 alternatives verified in-game (D7-3, iter 37 → confirmed iter 38)
