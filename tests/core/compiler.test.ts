...
describe('compile', () => {
  ...
  it('compiles RANGE with prefix and suffix', () => {
    ...
    expect(result).toBe('"даруют на ([6-9].|\\d..).*больше опыта"');
  });
  ...
  it('compiles RANGE with prefix, suffix, and round10', () => {
    ...
    expect(result).toBe('"увеличенное на ([2-9].|\\d..).*количество монстров"');
  });
  ...
  it('compiles RANGE with prefix and both min+max', () => {
    ...
    expect(result).toBe('"даруют увеличенное на (2[5-9]|[3-9].|\\d..).*количество дани" "даруют увеличенное на ([0-9]|[1-2].|30).*количество дани"');
  });
  ...
  it('compiles RANGE with prefix but no suffix', () => {
    ...
    expect(result).toBe('"даруют на ([5-9].|\\d..)"');
  });
  ...
  it('compiles RANGE with exact=true (no round10)', () => {
    ...
    expect(result).toBe('"(2[5-9]|[3-9].|\\d..).*количество монстров"');
  });
  ...
  it('compiles RANGE with exact=false (uses global round10)', () => {
    ...
    expect(result).toBe('"([2-9].|\\d..).*количество монстров"');
  });
  ...
  it('compiles RANGE with exact=true and prefix', () => {
    ...
    expect(result).toBe('"даруют увеличенное на (2[5-9]|[3-9].|\\d..).*количество дани"');
  });
